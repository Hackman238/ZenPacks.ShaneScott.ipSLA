...
class ipSLAmos( AliasPlugin ):
    """
    ipSLA mean opinion score report
    """
    ...
    def getColumns(self):
        return [
                ...
                Column('RawMOS', RRDColumnHandler( 'rttMonLatestJitterOperMOS' )),
                ]

    def getCompositeColumns(self):
        return [
                Column('MOS', PythonColumnHandler('float(RawMOS)/float(100)'))
                ]
